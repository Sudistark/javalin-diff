...
public final class Gzip {
  ...
  public Gzip(int level) {
    ...
    int i = this.level;
    if (!((0 <= i) ? ((i < 10) ? 1 : 0) : 0)) {
      int $i$a$-require-Gzip$1 = 0;
      String str = "Valid range for parameter level is 0 to 9";
